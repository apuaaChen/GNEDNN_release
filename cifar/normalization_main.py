...
from cifar.models import SerialNetNorm
from ops import Initializer, sPReLU, CenterConv2d, L2Norm2d, L1Norm2d, WnConv2d
...
# Description
parser = argparse.ArgumentParser(description='Experiments in Sec. 7.4: Normalization in Serial Network')
...
parser.add_argument('--norm_fn', choices=['none', 'bn', 'l2n', 'wn', 'swn', 'l1n'], default='bn')
...
# setup model
net = SerialNetNorm(depth=args.size, init_fn=initializer.initialization,
