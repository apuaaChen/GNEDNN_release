...
from imagenet.models import ResNetL1, ResNetL2
...
# for moment normalization
parser.add_argument('--l1', action='store_true', help='using L1 version')
...
def main_worker(gpu, ngpus_per_node, args_):
    ...
    if args.l1:
        model = ResNetL1
        print('using L1 version')
    else:
        model = ResNetL2
        print('using L2 version')
    ...
    if args_.resume:
        if os.path.isfile(args_.resume):
            ...
            args_.start_epoch = args_.start_epoch
