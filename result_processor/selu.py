...
exp_lists = {
    211: ['km_selu', 'km_seluv2_g1_e3', 'km_seluv2_g1_e7', 'km_seluv2_g2_e3'],
    212: ['orth_selu', 'orth_seluv2_g1_e3', 'orth_seluv2_g1_e7', 'orth_seluv2_g2_e3']
}

title = ['(a)KM', '(b)Orth']

marker = ['k-', 'r-', 'b-', 'm', 'y']
label = ['native', r'$\gamma=1, \epsilon=0.03$', r'$\gamma=1, \epsilon=0.07$', r'$\gamma=2, \epsilon=0.03$']
